...
function Earringsspage() {
  return (
    <div className='datails-page'>
          <div className="container datails  my-5">
            ...
            <div className="row">
              ...
              <div className="col-md-5 text-center">
                ...
                <div className="d-flex gap-3 justify-content-center mt-3">
                  <img src={Earrings} className="thumb-img" alt="" />
                  <img src={Earrings} className="thumb-img" alt="" />
                  <img src={Earrings} className="thumb-img" alt="" />
                </div>
              </div>
              ...
              <div className="col-md-7">
                ...
                <div className="d-flex gap-3 my-3">
                  <button className="btn btn-outline-primary"><i className="fa-solid fa-thumbs-up"></i> Like</button>
